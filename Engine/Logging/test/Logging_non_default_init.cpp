...
// $Id: //depot/main/Engine/Logging/test/Logging_non_default_init.cpp#3 $
// $DateTime: 2009/07/30 12:22:26 $

// Unit-test for Engine.Logging initialization with user-provided timer and output.
...
/// Checks how initialization with user-provided timer and output works.
void test_init()
{
...
{
   boost::unit_test::test_suite* test = BOOST_TEST_SUITE("Logging_non_default_init");
